...
export default function AnalyticsScreen() {
  ...
  return <SafeAreaView style={styles.safe} edges={["top"]}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    ...
    {tab === "Flow" ? <Flow total={total} admissions={admissions} /> : tab === "Quality" ? <Quality /> : <Resources medicineStock={medicineStock} />}
...
function Flow({ total, admissions }: { total: number; admissions: DailyAdmissionData[] }) {
  ...
  return <View style={styles.stack}>
    <ChartCard title="Patient flow — admissions" subtitle="Admissions over the last 7 days" values={recentAdmissions} color={c.primary} labels={["Thu", "Fri", "Sat", "Sun", "Mon", "Tue", "Today"]} />
